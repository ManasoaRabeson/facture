...
import { Search } from "../../Facture/Formulaire/search";
import { Count } from "../../Facture/Formulaire/count";
...
useEffect (()=>{
    const total = Number(sumProject) + Number(sumItems) + Number(sumFolder) +Number(sumCours);   
    setSumTotal(total);
    ...
    <>
      <form action={handleSubmit} className="flex flex-col gap-4">
                <div className="flex flex-col mx-12 bg-white rounded-md shadow-sm">
                    ...
                    <AjoutClient idEtp={idEtp} setIdEtp={setIdEtp}/>
                        {/* RIGHT */}
                        <div className="w-[45%] flex flex-col gap-2">
                            <div className="flex justify-end mb-4">
                                <p className="text-4xl font-semibold text-gray-600">Facture Proforma</p>
                            ...
                            <input type="hidden" id="invoice_bc" name="invoice_bc"/>
                            <div className="inline-flex items-center gap-4">
                                <div className="flex justify-end w-1/3">
                    ...
                    {/* --SERVICE-- */}
                    <Search idEtp={idEtp} data={data} setSumFolder={setSumFolder} setSumItems={setSumItems} setSumProject={setSumProject}
                    setSumCours={setSumCours} IsProforma={IsProforma}/>
                    {/*-- AFFICHAGE COUNT -- */}
                    <Count sumTotal={sumTotal}/>
                    {/* -- MODE DE PAIEMENT --*/}
